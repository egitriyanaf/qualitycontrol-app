...
@section('content')
    <form id="demo-form2" data-pars metley-validate class="form-horizontal form-label-left" method="post" action="{{ url('admin/simpan_cek_bahan_kemas') }}">
  <div class="row">
        @csrf
      <div class="col-md-12">
        <div class="x_panel">
...
<!--                   <div class="item form-group">
                  ...
                  <div class="item form-group">
                    <label class="control-label col-md-2 col-sm-2 label-align">Jenis</label>
                    <div class="col-md-10 col-sm-10 ">
                      <select class="form-control" id="jenis" name="jenis" required>
                        @foreach($bahanKemas as $p)
