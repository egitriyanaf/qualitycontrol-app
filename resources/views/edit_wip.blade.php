...
@section('content')
    <form id="demo-form2" data-pars metley-validate class="form-horizontal form-label-left" method="post" action="{{ url('admin/update_wip/'.$data->id_wip) }}">
  <div class="row">
        @csrf
      <div class="col-md-12">
        <div class="x_panel">
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="item form-group">
                    ...
                    <div class="col-md-10 col-sm-10 ">
                      <input type="time" id="jam" name="jam" class="form-control" value="{{ $data->jam }}" required>
                    </div>
                  </div>
                  <div class="item form-group">
                    ...
                    <div class="col-md-10 col-sm-10 ">
                      <input type="text" id="bentuk" name="bentuk" class="form-control" value="{{ $data->bentuk }}" required>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  ...
                  <div class="item form-group">
                    ...
                    <div class="col-md-10 col-sm-10 ">
                      <input required type="text" value="{{ $data->warna }}" id="warna" name="warna" class="form-control">
                    </div>
                  </div>
                </div>
              </div>
