...
@section('content')
  <div class="row">
      <div class="col-md-12">
        <div class="x_panel">
          <div class="x_title">
            <a href="{{ url('admin/tambah_bahan_baku') }}" class="btn btn-secondary"><i class="fa fa-plus"></i> Tambah</a>
            <a href="{{ url('admin/kode_bahan_baku') }}" class="btn btn-secondary"><i class="fa fa-plus"></i> Kode Bahan Baku</a>
          </div>
          <div class="x_content">
              ...
              <tbody>
                @foreach($data as $d)
                  <tr>
                    ...
                    <td>{{ $d->nama }}</td>
                    <td>
                      <a href="{{ url('admin/edit_bahan_baku/'.$d->id) }}" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a>
