...
@section('content')
    <form id="demo-form2" data-pars metley-validate class="form-horizontal form-label-left" method="post" action="{{ url('admin/update_packing_bahan_kemas/'.$data->id_bahan_kemas) }}">
  <div class="row">
        @csrf
      <div class="col-md-12">
        <div class="x_panel">
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="item form-group">
                    ...
                    <div class="col-md-10 col-sm-10 ">
                      <input type="text" value="{{ $data->supplier }}" id="supplier" name="supplier" class="form-control" required>
                    </div>
                  </div>
                  <div class="item form-group">
                  ...
                  <div class="item form-group">
                    ...
                    <div class="col-md-10 col-sm-10 ">
                      <input type="number" id="jumlah" name="jumlah" min="0" step="1" value="{{ $data->jumlah }}" class="form-control" required>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  ...
                  <div class="item form-group">
                    <label class="col-form-label col-md-2 col-sm-2 label-align" for="lot">Lot
                    </label>
                    <div class="col-md-10 col-sm-10 ">
                      <input required type="text" id="lot" name="lot" class="form-control" value="{{ $data->lot }}">
                    </div>
                  </div>
                  <div class="item form-group">
                    <label class="col-form-label col-md-2 col-sm-2 label-align" for="delaminasi">Delaminasi
                    </label>
                    <div class="col-md-10 col-sm-10 ">
                      <input required type="text" id="delaminasi" name="delaminasi" class="form-control" value="{{ $data->delaminasi }}">
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div class="col-md-12">
        <a href="{{ url('admin/pemeriksaaan_bahan_kemas') }}" class="btn btn-danger" type="button">Kembali</a>
