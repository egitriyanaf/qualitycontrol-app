  ...
  <div class="row">
      <div class="col-md-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            <form id="demo-form2" data-pars metley-validate class="form-horizontal form-label-left" method="post" action="{{ url('admin/update_user/'.$data->id) }}">
              @csrf
              <div class="item form-group">
                <label class="col-form-label col-md-3 col-sm-3 label-align" for="nama_lengkap">Nama Lengkap
                </label>
                <div class="col-md-6 col-sm-6 ">
                  <input type="text" id="nama_lengkap" name="nama_lengkap" required="required" class="form-control " value="{{ $data->name }}">
                </div>
              </div>
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                  <input type="email" id="email" name="email" required="required" class="form-control" value="{{ $data->email }}">
                </div>
              </div>
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                  ...
                  <input id="password_old" class="form-control" type="hidden" name="password_old" id="password_old" value="{{ $data->password }}">
                </div>
              </div>
              <div class="item form-group">
