...
@section('content')
  <div class="row">
    <form id="demo-form2" data-pars metley-validate class="form-horizontal form-label-left" method="post" action="{{ url('admin/simpan_qc_barang_jadi') }}">
        @csrf
      <div class="col-md-12">
        <div class="x_panel">
          <div class="own-title">
          ...
          <div class="x_content">
              <input type="hidden" name="kode_qc_barang_jadi" id="kode_qc_barang_jadi">
              <div class="row">
                <div class="col-md-6">
        ...
        <div class="x_panel">
          ...
          <div class="x_content">
            <table class="table table-bordered">
              ...
              <tbody>
                <tr>
                  <td><input type="text" id="no_do" name="no_do" class="form-control" required></td>
                  <td><input type="time" id="mulai" name="mulai" class="form-control" required></td>
                  <td><input type="time" id="selesai" name="selesai" class="form-control" required></td>
                  <td><input type="text" id="tujuan" name="tujuan" class="form-control" required></td>
                  <td><input type="text" id="no_polisi" name="no_polisi" class="form-control" required></td>
                </tr>
              </tbody>
            </table>
          </div>
            ...
            <table class="table table-bordered">
              ...
              <tbody>
                <tr>
                  ...
                  <td><input type="text" name="verifikasi" id="verifikasi" class="form-control" required></td>
                  <td><textarea class="form-control" name="keterangan" id="keterangan" rows="4"></textarea></td>
                </tr>
              </tbody>
            </table>
          </div>
