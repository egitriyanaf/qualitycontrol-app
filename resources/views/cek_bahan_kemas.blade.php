      ...
      <div class="col-md-12">
        <div class="x_panel">
          ...
          <!--   <h2>Inbox Design<small>User Mail</small></h2>
            ...
            <a href="{{ url('admin/tambah_cek_bahan_kemas') }}" class="btn btn-secondary"><i class="fa fa-plus"></i> Tambah</a>
          </div>
          <div class="x_content">
              ...
              <tbody>
                @foreach($data as $d)
                  <tr>
                    ...
                    <td>{{ $d->satuan }}</td>
                    <td>
                      <a href="{{ url('admin/edit_cek_bahan_kemas/'.$d->id) }}" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a>
...
<script type="text/javascript">
  function del(id) {
    Swal.fire({
      ...
      if (result.value) {
        window.location.href = "{{ url('admin/hapus_cek_bahan_kemas') }}"+'/'+id; 
      }
    })
  }
</script>
