...
@section('content')
    <form id="demo-form2" data-pars metley-validate class="form-horizontal form-label-left" method="post" action="{{ url('admin/update_proses_produksi/'.$data->id) }}">
  <div class="row">
        @csrf
      <div class="col-md-12">
        <div class="x_panel">
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="item form-group">
                    ...
                    <div class="col-md-10 col-sm-10 ">
                      <input type="text" id="shift" name="shift" required="required" class="form-control" value="{{ $data->shift }}">
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="item form-group">
                    ...
                    <div class="col-md-10 col-sm-10 ">
                      <input type="text" value="{{ $data->no_mesin }}" id="no_mesin" name="no_mesin" class="form-control">
                    </div>
                  </div>
                  <div class="item form-group">
                    ...
                    <div class="col-md-10 col-sm-10 ">
                      <input type="text" id="no_microwave" name="no_microwave" value="{{ $data->no_microwave }}" class="form-control">
                    </div>
                  </div>
                  ...
                  <div class="item form-group">
                    ...
                    <div class="col-md-10 col-sm-10 ">
                      <input type="text" id="no_lot" name="no_lot" class="form-control" value="{{ $data->no_lot }}">
                    </div>
                  </div>
                </div>
              </div>
