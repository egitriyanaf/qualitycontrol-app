...
@section('content')
  <div class="row">
      <div class="col-md-12">
        <div class="x_panel">
          <div class="x_title">
            <button type="button" class="btn btn-secondary btn-sm" data-toggle="modal" data-target="#tambah-bahan-kemas"><i class="fa fa-plus"></i> Tambah</button>
          </div>
          <div class="x_content">
...
<div class="modal fade bs-example-modal-sm" id="tambah" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-sm">
    <div class="modal-content">

      <form method="post" action="{{ url('admin/simpan_kode_bahan_kemas') }}">
        @csrf
        <div class="modal-header">
