...
@section('content')
    <form id="demo-form2" data-pars metley-validate class="form-horizontal form-label-left" method="post" action="{{ url('admin/simpan_packing_bahan_kemas') }}">
  <div class="row">
        @csrf
      <div class="col-md-12">
        <div class="x_panel">
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="item form-group">
                    ...
                    <div class="col-md-10 col-sm-10 ">
                      <input type="number" id="jumlah" name="jumlah" min="0" step="1" class="form-control" required>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  ...
                  <div class="item form-group">
                    ...
                    <div class="col-md-10 col-sm-10 ">
                      <input required type="text" id="lot" name="lot" class="form-control">
                    </div>
                  </div>
                  <div class="item form-group">
                    ...
                    <div class="col-md-10 col-sm-10 ">
                      <input required type="text" id="delaminasi" name="delaminasi" class="form-control">
                    </div>
                  </div>
