...
@section('content')
    <form id="demo-form2" data-pars metley-validate class="form-horizontal form-label-left" method="post" action="{{ url('admin/update_packing_hasil_kemas/'.$data->id_hasil_kemas) }}">
  <div class="row">
        @csrf
      <div class="col-md-12">
        <div class="x_panel">
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="item form-group">
                    ...
                    <div class="col-md-10 col-sm-10 ">
                      <input type="text" value="{{ $data->no_lot }}" id="no_lot" name="no_lot" class="form-control" required>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  ...
                  <div class="item form-group">
                    ...
                    <div class="col-md-10 col-sm-10 ">
                      <input required type="date" id="exp_date" name="exp_date" value="{{ $data->exp_date }}" class="form-control">
                    </div>
                  </div>
                </div>
              </div>
              ...
              <tbody>
                @foreach($dataDetail as $dd)
                  <tr id="{{ $j }}">
                    ...
                    <td><input type='text' class='form-control' name='kemasan[]' value="{{ $dd->kemasan }}" required></td>
                    <td><input type='text' class='form-control' name='seal[]' value="{{ $dd->seal }}" required></td>
                    <td><input type='text' class='form-control' name='kodefikasi[]' value="{{ $dd->kodefikasi }}" required></td>
                    <td><input type='text' class='form-control' name='kebocoran[]' value="{{ $dd->kebocoran }}" required></td>
                    <td><input type='text' class='form-control' name='metal_detector[]' value="{{ $dd->metal_detector }}" required></td>
...
<script>
  ...
  function myDeleteFunctionById(x) {
    // $("#"+x).remove();
    $("#packing_hasil_kemas tr:eq("+x+")").remove();
  }
</script>
@endsection