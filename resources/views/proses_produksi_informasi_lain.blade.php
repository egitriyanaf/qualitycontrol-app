...
@section('content')
  <div class="row">
      <div class="col-md-12">
        <div class="x_panel">
          <div class="x_title">
            <a href="{{ url('admin/tambah_proses_produksi_informasi_lain') }}" class="btn btn-secondary"><i class="fa fa-plus"></i> Tambah</a>
          </div>
          <div class="x_content">
              ...
              <tbody>
                @foreach($data as $d)
                  <tr>
                    ...
                    <td>{{ $d->bahan_baku }}</td>
                    <td>
                      <a href="{{ url('admin/edit_proses_produksi_informasi_lain/'.$d->id) }}" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a>
